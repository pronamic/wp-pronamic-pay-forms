...
- Added `.wp-env.json` and wp-env npm scripts for local development environment.
- Added `.editorconfig` for consistent coding styles.
- Added `clean-css-cli` to devDependencies for CSS minification.
...
[1.3.0]: https://github.com/pronamic/wp-pronamic-pay-forms/compare/v1.2.0...v1.3.0
...
- Happy 2024. ([c673cf4](https://github.com/pronamic/wp-pronamic-pay-forms/commit/c673cf42c0268e16472b79469b8d37d3a4b17f31))

Full set of changes: [`1.1.2...1.1.3`][1.1.3]

[1.1.3]: https://github.com/pronamic/wp-pronamic-pay-forms/compare/v1.1.2...v1.1.3
